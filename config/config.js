...
module.exports = {
  ...
  "RECAPTCHA_PRIV_KEY": process.env.RECAPTCHA_PRIV_KEY || '6LetUYsUAAAAAJz82nly1tsHjTzEmyyzLEjrghtr',
  "RECAPTCHA_SITE_KEY": process.env.RECAPTCHA_SITE_KEY || '6LetUYsUAAAAAHonvpfx0f21kDJLwgF3FFjmq8g8',
