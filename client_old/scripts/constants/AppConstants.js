define(['lib/key-mirror'], function(KeyMirror){
    ...
    return {
        ...
        Engine: {
            ...
            MAX_BET: 100000000000000000 /** Max bet per game 1,000,000 Bits, this will be calculated dynamically in the future, based on the invested amount in the casino **/
        },
